                ...
                <g:if test="${selection}">
                    <li>
                        <select:link action="list" selection="${selection}" params="${[view: 'list']}">
                            <g:message code="crmProject.show.result.label" default="Show result in list view"/>
                        </select:link>
                    </li>
                </g:if>
    ...
    <g:form>
        ...
        <div class="form-actions btn-toolbar">
            <crm:hasPermission permission="crmProject:edit">
                <g:link action="addRole" id="${crmProject.id}" class="btn btn-success" elementId="add-role">
